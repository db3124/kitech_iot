...
public class MainForSpring8 {
	...
	public static void main(String[] args) throws IOException {
		...
		MemberRegisterService rservice1 = ctx.getBean("registerService", MemberRegisterService.class);
		MemberRegisterService rservice2 = ctx.getBean("registerService",MemberRegisterService.class);

		System.out.println("rservice1==rservice2 -> " + (rservice1 == rservice2));
		System.out.println("---------------------------");
		...
		System.out.println("cservice1==cservice2 -> " + (cservice1 == cservice2));
		System.out.println("---------------------------");
	}
}
