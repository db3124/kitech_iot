...
public class FruitSellerMain {
	...
	public static void main(String[] args) {// main은 인스턴스 생성에 아무런 영향을 주지 않음
		
		// 셀러1  생성
		FruitSeller seller; // 참조변수 생성 : 인스턴스의 주소를 저장
//		seller = new FruitSeller(0, 30, 1500);// 인스턴스 생성 -> 인스턴스 메모리의 주솟값을 반환
...
//		System.out.println("구매자가 보유한 돈의 액수 : "+FruitBuyer.myMoney);
